      ...
      <section className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-7xl md:text-8xl lg:text-9xl font-bold mb-20 tracking-tight">
            ...
            <span
              className="block bg-linear-to-r from-lime-400 via-lime-500 to-lime-600 text-transparent bg-clip-text"
              style={{
          ...
          <div className="flex justify-center">
            <button
              ...
              className="group relative px-20 py-6 text-xl md:text-2xl font-semibold text-black bg-linear-to-r from-lime-400 to-lime-500 overflow-hidden transition-all duration-500 hover:scale-105"
              style={{
                fontFamily: "Georgia, serif",
          ...
          <div className="mt-24 flex justify-center items-center gap-4">
            <div className="w-24 h-px bg-linear-to-r from-transparent to-lime-500"></div>
            <div className="w-2 h-2 bg-lime-500 rotate-45"></div>
            <div className="w-24 h-px bg-linear-to-l from-transparent to-lime-500"></div>
          </div>
        </div>
      </section>
      <Menu />
